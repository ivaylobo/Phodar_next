              ...
              <div className="container">
                  ...
                  <div className={styles.allWrapper}>
                      <div className={`${styles.rowWrapper} ${styles.rowWrapperFirst}`}>
                          {[
                              body?.exhibitions?.imgFirst?.node,
                              body?.exhibitions?.imgSecond?.node,
                          ]
                              .filter(
                                  (node): node is NonNullable<typeof node> &
                                      Required<{ sourceUrl: string }> =>
                                      !!node && typeof node.sourceUrl === 'string',
                              )
                              .map((node, index) => (
                                  <div
                                      key={`exh-first-row-${index}`}
                      ...
                      <div className={`${styles.rowWrapper} ${styles.rowWrapperSecond}`}>
                          {[
                              body?.exhibitions?.imgThird?.node,
                              body?.exhibitions?.imgFourth?.node,
                          ]
                              .filter(
                                  (node): node is NonNullable<typeof node> &
                                      Required<{ sourceUrl: string }> =>
